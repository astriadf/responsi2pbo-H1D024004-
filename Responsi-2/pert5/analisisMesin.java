class analisisMesin {
    public static void main(String[] args) {
        ...
        for (defaultMesin m : mesin) {
            if (m instanceof mesinMotor) ((mesinMotor) m).suaraMesin();
            else if (m instanceof mesinTraktorListrik) ((mesinTraktorListrik) m).suaraMesin();
        ...
        System.out.println("\n=== MESIN PERFORMA TERTINGGI ===");
            System.out.println(namaMax + " -> " + max);
